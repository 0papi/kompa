...
export default function EditListingPage() {
  ...
  const defaultValues: Partial<ListingFormData> = {
    ...
    price: listing.price,
    pricePerSquareFoot: listing.pricePerSquareFoot || undefined,
    ...
    propertyTaxes: listing.propertyTaxes || undefined,
    annualInsurance: listing.annualInsurance || undefined,
    valuationMethod: listing.valuationMethod,
