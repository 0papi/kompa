...
export const listingFormSchema = z.object({
  ...
  pricePerSquareFoot: z.coerce
    .number()
    .min(0, "Price per sq ft must be positive")
    .optional(),
  ...
  bedrooms: z.coerce
    ...
    .max(20, "Invalid number of bedrooms"),
  comparablePrice: z.coerce
    .number()
    .min(0, "Comparable price must be 0 or more"),
  bathrooms: z.coerce
    .number()
    .min(0, "Bathrooms must be 0 or more")
    .max(20, "Invalid number of bathrooms"),
  ...
  stories: z.coerce
    ...
    .optional()
    .default(1),
  garageSpaces: z.coerce
    .number()
    .min(0, "Garage spaces must be 0 or more")
    .max(10)
    .optional(),
  ...
  condition: z
    .string()
    .min(1, "Condition description must be at least 10 characters")
    .max(1000, "Condition description must be less than 1000 characters"),

  // Financial Details
  hoaFees: z.coerce.number().min(0, "HOA fees must be 0 or more").optional(),
  propertyTaxes: z.coerce
    .number()
    .min(0, "Property taxes must be 0 or more")
    .optional(),
  annualInsurance: z.coerce
    .number()
    .min(0, "Annual insurance must be 0 or more")
    .optional(),
  ...
  daysOnMarket: z.coerce
    .number()
    .min(0, "Days on market must be 0 or more")
    .optional(),
